...
class PostCode {
  ...
  static List<int> row({
    ...
    // \x1d\x21\x01
    const cFontCompressed = '\x1d\x21\x01'; // Сжатый шрифт
    ...
    // Добавим поддержку бумаги 58 мм
      case FontSize.size58:
        maxCaracteres = 42; // Можно настроить в зависимости от того, сколько символов вмещается на бумаге 58 мм
...
enum FontSize { normal, compressed, doubleHeight, doubleWidth, big, superBig, size58 }
